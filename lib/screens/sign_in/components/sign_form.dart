...
class _SignFormState extends State<SignForm> {
  ...
  void initState() {
    ...
    super.initState();
    // SPHelper.sp.getData("remember")?? SPHelper.sp.insetBoolData("remember",false);
  }
  ...
  void login(context) async {
    if (_formKey.currentState.validate()) {
      ...
      DocumentSnapshot<Map<String, dynamic>> snapshot =
          await FirebaseHelper.firebaseHelper.Login(email, password, context);
      if (snapshot != null) {
            ...
            children: [
              Checkbox(
                ...
                onChanged: (value) {
                  setState(() {
                    remember = value;
                    SPHelper.sp.insetBoolData("remember", value);
                  });
                },
              ),
              Text("Remember me"),
